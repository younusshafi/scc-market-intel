...
NEWS_ANALYSIS_SYSTEM_PROMPT = (
    ...
    "CRITICAL FILTER: If the article is about sports (football, cricket, "
    "racing), entertainment, cultural events, diplomatic visits, weather, "
    "or wildlife — mark it NOT relevant regardless of whether a tracked "
    "competitor name appears. 'Arab Contractors' is also the name of an "
    "Egyptian football club — sports results mentioning this name are "
    "NOT relevant. Only mark articles relevant if they discuss actual "
    "construction, infrastructure, tenders, or business operations.\n\n"
