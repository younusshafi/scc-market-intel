...
NEWS_ANALYSIS_SYSTEM_PROMPT = (
    ...
    "SCC IMPLICATION RULES (CRITICAL):\n"
    "- NEVER write generic phrases like 'could lead to new business opportunities' "
    "or 'could be a potential bid opportunity'\n"
    ...
    "- If the connection to SCC is weak or the article is barely relevant, "
    "write 'Low direct relevance to SCC civil infrastructure work' instead of "
    "inventing a vague connection\n\n"
    "GOOD implication: 'Strabag's EUR 102M Oman road contract on the Sohar-Buraimi "
    "axis directly competes with SCC. Monitor MTCIT tenders for related package work.'\n"
    "GOOD implication: 'Nama RO 1B pipeline expansion targets Al Batinah. Pipeline "
    "construction tenders in SCC category likely within 6-12 months.'\n"
    "BAD implication: 'Could lead to new business opportunities for SCC.'\n"
    "BAD implication: 'This could be a potential bid opportunity.'\n\n"
    ...
    "\"scc_implication\": \"Strabag's EUR 102M road contract on Sohar-Buraimi "
    "axis directly competes with SCC core capability.\", "
